    ...
    <table border="bordered">
        ...
        foreach($data as $row){
            ...
            foreach($row["children"] as $item){
                echo "<tr><td></td><td><input class='2lvl prev_id=".$id_1_layout."' id=".++$id_2_layout." value='".$item["name"]."'></td><td></td><td></td></tr>";
                echo "<tr><td></td><td></td><td>Инструменты:</td><td></td></tr>";
                foreach($item["tools"] as $tools){
                     echo "<tr><td></td><td></td><td></td><td><input class='tools prev_id=".$id_2_layout."' value='".$tools["name"]."'></td></tr>";
                }
                echo "<tr><td></td><td></td><td>Приборы:</td><td></td></tr>";
                foreach($item["equipment"] as $equipment){
                     echo "<tr><td></td><td></td><td></td><td><input class='equipment prev_id=".$id_2_layout."' value='".$equipment["name"]."'></td></tr>";
                }
            }
        }
        ?>
