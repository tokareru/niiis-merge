...
bg-primary">
     <input value="Очистить" type="button" class="btn btn-sm btn-custom bg-primary"id="spec_field_clear">
</div>
<!--
<div class="col-md-12">
    <div class="row">
        <div class="col-12">
            <input type="button" class="btn btn-custom edit_mode_onoff" value="режим редактирования">
        </div>
    </div>
    <div class="row p-3 edit_div_toggle">
        <div class="col-3">
            <input type="button" value="добавить строку" class="btn btn-sm btn-custom add_row">
            <input type="text" row="row" placeholder="номер строки" class="btn border btn-sm add_row_text">
        </div>
        <div class="col-3">
            <input type="button" value="удалить строку: " class="btn btn-sm btn-custom del_row">
        ...
        <div class="col-3">
            <button type="button" class="btn btn-sm btn-custom cell_to_edit_but">сделать ячейку редактируемой:</button>
