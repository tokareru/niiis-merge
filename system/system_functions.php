...
class sys {
  ...
  static function db_connect($db_host, $user, $password, $db) {
    ...
    sys::$mssql_link = $dbconn3 = pg_connect("host=localhostz port=5432 dbname=niiis user=dmitry password=ubvyfpbz50");
    if (!sys::$mssql_link) {
      throw new Exception("Failed to connect to database");
    }
    
    $PDO = new PDO("pgsql:host='localhost';dbname=$db", "dmitry", "ubvyfpbz50");
    sys::$PDO=$PDO;
  }
