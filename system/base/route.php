            ...
            if ($modul == 'ajax') {
                ...
                if (file_exists("system/controllers/" . $controller_file)) {
                    ...
                    if (class_exists($controller_name)) {
                        ...
                        // если мы не администратор и главный контроллер, к которому мы обращаемся, 
                        // это admin_cab - выдаем предупреждение
                        if ($_SESSION["niiis"]["role"] != "administrator" && $path[0] == 'admin_cab') {
//                            echo "<p align='center'>Необходимо авторизоваться как Администратор!</p>";
//                            include "system/views/admin/admin_error_view.php";
                        }
