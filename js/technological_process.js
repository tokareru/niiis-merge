...
function setTechProcess($container, data = {name: "", operations: []}) {
    ...
    $container.append(`
        <li class='techNameDropped' tech-id='${data.id}' tech-lvl='${data.lvl}'>
            ...
            <ul style='min-height: 35px;' class='nested border-bottom pb-2 myNested techOperationsDropArea border border-color-transparent'>
                ${operations}
            </ul>
        </li>
    `)
...
function combineTechOperation(field, isDeleted) {
    ...
    return `
        <li class="techOperation" tech-lvl="${field.lvl}" tech-id="${field.id}">
            ...
            <ul style='min-height: 35px;' class="nested techNodesDropArea border border-color-transparent">
                ${innerNodes}
            </ul>
        </li>
    `;
...
function combineTechNode(node) {
    ...
    let _node = `
        <li class="techNode" tech-lvl="${node.lvl}" tech-id="${node.id}">
            ...
            <ul style='min-height: 35px;' class='nested border-bottom pb-2 myNested techFieldsDropArea border border-color-transparent'>
                ${fields}
            </ul>
        </li>
    `;
