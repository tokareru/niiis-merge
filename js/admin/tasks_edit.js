...
function combineTriggerSelection(selectedTriggerName = "") {
    return `
        <select class="form-control task-trigger-selection shadow-none">
            ...
            <option ${(selectedTriggerName === "checkMyTaskRoute") ? "selected": ""} task-description='Проверить "Мои маршруты" во вкладке "Маршруты заданий"' value="checkMyTaskRoute">Проверка "Моих маршрутов"</option>
